(function() {
    ...
    var e = BMapLib.TextIconOverlay = function(f, h, g) {
        ...
        this._text = h;
        this._options = g || {};
        this._styles = this._options.styles || []; (!this._styles.length) && this._setupDefaultStyles();
    };
    d.lang.inherits(e, BMap.Overlay, "TextIconOverlay");
    e.prototype._setupDefaultStyles = function() {
        var h = [ 34, 38, 48, 58,68];
        // var h = [53, 56, 66, 78, 90];
        for (var g = 0, f; f = h[g]; g++) {
            var url = "";
            if (g==0){
                url="/bmap/juhedian/green.png";
            } else if (g==1){
                url="/bmap/juhedian/blue.png";
            } else if (g==2){
                url="/bmap/juhedian/yellow.png";
            } else if (g==3){
                url="/bmap/juhedian/red.png";
            } else if (g==4){
                url="/bmap/juhedian/purple.png";
            }
            this._styles.push({
                "url": url,
    ...
    e.prototype._buildCssText = function(g) {
        ...
        if (d.browser.ie < 7) {
            ...
            m.push("background-repeat:no-repeat;");
            m.push("background-size:100% 100%;");
            m.push("-moz-background-size:100% 100%;");
            var i = "0 0"; (j instanceof BMap.Size) && (i = j.width + "px " + j.height + "px");
    ...
    e.prototype._bind = function() {
        ...
        d.event.on(this._domElement, "mouseover",
            function(j) {
                g.dispatchEvent(h(j, new f("onmouseover")));
            });
        d.event.on(this._domElement, "mouseout",
            function(j) {
                g.dispatchEvent(h(j, new f("onmouseout")));
            });
        d.event.on(this._domElement, "click",
            function(j) {

...
(function() {
        ...
        BMapLib.DistanceTool = function(map, opts){
            ...
            var _OperationMask = {
                ...
                getDrawPoint : function(e, n) {
                    ...
                    if (t != _OperationMask.getDom(this._map) && n == true) {
                    ...
                    if (t != _OperationMask.getDom(this._map) && 
            ...
            this._OperationMask = _OperationMask;
        }
    ...
    DistanceTool.prototype._bind = function(){
        ...
        baidu.on(this._map.getContainer(), "mousemove", function(e){
            ...
            if (t != me._OperationMask.getDom(me._map)) {
    ...
    DistanceTool.prototype.open = function(){
        ...
        var distClick = function(e) {
            ...
            e = window.event || e;
            var poi = me._OperationMask.getDrawPoint(e, true);
            // 验证计算得出的该点的位置合理性
        ...
        var distDblclick = function(e) {
            ...
            window.getSelection().empty(); // 清除选中
            // 结束时，删除绑定的事件
            baidu.un(me._OperationMask.getDom(me._map), "click", distClick);
            baidu.un(document, "mousemove", distMove);
            baidu.un(me._OperationMask.getDom(me._map), "dblclick", distDblclick);            
            baidu.un(document, "keydown", distKeyDown);
            baidu.un(me._OperationMask.getDom(me._map), "mouseup", distMouseUp);
        ...
        // 创建透明覆盖层，并设置鼠标样式
        me._OperationMask.show(this._map);
        this._setCursor(this._opts.cursor);

        // 绑定全部事件
        baidu.on(me._OperationMask.getDom(this._map), "click", distClick);
        baidu.on(document, "mousemove", distMove);
        baidu.on(me._OperationMask.getDom(this._map), "dblclick", distDblclick);
        baidu.on(document, "keydown", distKeyDown);
        baidu.on(me._OperationMask.getDom(this._map), "mouseup", distMouseUp);
        
        // 将绑定的事件、和对应的绑定对象，记录在数组中
        this.bindFunc = [
            {elem : me._OperationMask.getDom(this._map), type : "click", func : distClick}, 
            {elem : me._OperationMask.getDom(this._map), type : "dblclick", func : distDblclick},
            {elem : document, type : "mousemove", func : distMove},
            {elem : document, type : "keydown", func : distKeyDown},
            {elem : me._OperationMask.getDom(this._map), type : "mouseup", func : distMouseUp}];
        return true;
    };
    ...
    DistanceTool.prototype._setCursor = function(cursor){
        ...
        this._OperationMask._setCursor(csr);
    };
